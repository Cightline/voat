...
configFilePath = r'../config/config.json'
configParser.read(configFilePath)

# logger taken from Tzury Bar Yochay
# https://github.com/tzuryby
...
class Logger:   
	...
	def __init__(self):
		...
		self.logger = logging.getLogger('decent-log')
		self.logger.setLevel(logging.DEBUG)
		
		# file handler
		self.fh = logging.FileHandler('decent-log.log')
